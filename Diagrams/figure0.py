...
def main_figure0(evaluation_results, admission_chance_results, insurance_cost_results, used_car_prices_results, metric, dpi):
    """
    ...
    Y_SIZE = {
        ...
        "MSE": {"Admission_Chance": 0.03, "Insurance_Cost": 10**9/5*0.8, "Used_Car_Prices": 10**9*2.5},
    ...
    fig.legend(handles, labels, loc='center', bbox_to_anchor=(0.5, -0.02), ncol=4, fontsize=16)
